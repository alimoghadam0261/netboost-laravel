...
<div dir="rtl" class="max-w-5xl mx-auto px-4 bg-white dark:bg-gray-900 text-black dark:text-white">
    ...
    <br>
    <div class="p-4 bg-sky-400 shadow-lg rounded-[15px] flex justify-around">
        <div>
            <form  wire:submit.prevent="save" class="text-right border-2 p-2 rounded-md border-blue-600">

            <label for="">ایمیل</label><br>
                <input wire:model="email" type="email"  placeholder="email" class="w-[400px] rounded-sm text-left px-2">
                <br>
                @error('email') <span>{{ $message }}</span> @enderror
                <br><br>
                <label for="">شماره تماس</label><br>
                <input wire:model="phone" type="number"  placeholder="your phone" class="w-[400px] rounded-sm  text-left px-1">
                <br>
                @error('phone') <span>{{ $message }}</span> @enderror
                <br><br>
                <label for="">نظرات شما</label><br>
                <textarea wire:model="content" class="rounded-sm" name="" id="" cols="43" rows="10"></textarea>
                <br>
                @error('content') <span>{{ $message }}</span> @enderror
                <br><br>
                <button class="bg-blue-600 p-1 rounded-md w-[400px]" type="submit">ارسال</button>
            </form>

        </div>
        <div>
            <h2 class="text-[18px] text-gray-700">تماس با ما</h2>
            <br>
            <p>
                با تکمیل فرم روبرو میتوانید نظرات خود را به ما برسانید
            </p>
            <br>
            <a href="https://instagram.com/ariyabodgroup" aria-label="صفحه اینستاگرام آریابُد" ><i class="fa-brands fa-instagram m-2 transition-all duration-400 hover:text-white hover:scale-[1.1] fa-2x"></i>ariyabodgroup</a><br>
            <a href="https://www.youtube.com/@NetBoost021" aria-label="صفحه یوتوب آریابُد" ><i class="fa-brands fa-youtube m-2 transition-all duration-400 hover:text-white hover:scale-[1.1] fa-2x"></i>netboost021</a><br>
            <a href="https://t.me/ariyabodgroup" aria-label="صفحه تلگرام آریابُد" ><i class="fa-brands fa-telegram m-2 transition-all duration-400 hover:text-white hover:scale-[1.1] fa-2x"></i>ariyabodgroup</a><br>
            <a href="mailto:netboost021@gmail.com" aria-label="صفحه ارسال ایمیل آریابُد"><i class="fa fa-envelope m-2 transition-all duration-400 hover:text-white hover:scale-[1.1] fa-2x"></i>netboost021@gmail.com</a>
            <br><br>
