...
<div id="pos-article-text-card-106821"></div>
        ...
        <div class="flex justify-around">
            ...
            <a target="_blank" href="https://yt6d.com/en/"><button class="bg-red-400 p-2 m-1 rounded-md transition-all w-[200px]h-[50px]  duration-300 hover:bg-red-600 hover:text-white">لینک اول دانلود از یوتوب</button></a>
            <a target="_blank" href="https://en.greenconvert.net/"><button class="bg-red-400 p-2 m-1 rounded-md transition-all w-[200px] h-[50px] duration-300 hover:bg-red-600 hover:text-white">لینک دوم دانلود از یوتوب</button></a>
            <a target="_blank" href="https://y2mate.nu/en-szSi/"><button class="bg-red-400 p-2 m-1 rounded-md transition-all  w-[200px] h-[50px]   duration-300 hover:bg-red-600 hover:text-white">لینک سوم دانلود از یوتوب</button></a>
       </div>
        <br>

        
        <div class="flex justify-around p-2">
            <a target="_blank" href="https://snapins.ai/"><button class="bg-pink-400 p-2 m-1 rounded-md transition-all duration-300  w-[200px] h-[50px]  hover:bg-pink-600 hover:text-white">لینک اول دانلود از اینستاگرام </button></a>
            <a target="_blank" href="https://igram.world/"><button class="bg-pink-400 p-2 m-1 rounded-md transition-all duration-300  w-[200px] h-[50px]  hover:bg-pink-600 hover:text-white">لینک دوم دانلود از اینستاگرام </button></a>
            <a target="_blank" href="https://fastdl.app/en"><button class="bg-pink-400 p-2 m-1 rounded-md transition-all duration-300  w-[200px] h-[50px]  hover:bg-pink-600 hover:text-white">لینک سوم دانلود از اینستاگرام </button></a>
        </div>
<br>
